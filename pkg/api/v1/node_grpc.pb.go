...
func (c *nodeServiceClient) ReportStatus(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/convergedcomputing.org.grpc.v1.NodeService/ReportStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeServiceClient) AssignTask(ctx context.Context, in *Request, opts ...grpc.CallOption) (NodeService_AssignTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &NodeService_ServiceDesc.Streams[0], "/convergedcomputing.org.grpc.v1.NodeService/AssignTask", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *nodeServiceAssignTaskClient) Recv() (*WorkRequest, error) {
	m := new(WorkRequest)
...
func _NodeService_ReportStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/convergedcomputing.org.grpc.v1.NodeService/ReportStatus",
	}
...
func _NodeService_ReportResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WorkResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).ReportResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/convergedcomputing.org.grpc.v1.NodeService/ReportResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).ReportResult(ctx, req.(*WorkResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (x *nodeServiceAssignTaskServer) Send(m *WorkRequest) error {
